...
const SignUp = () => {
  return (
    ...
    <div className="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl">
      <div className="hidden bg-cover lg:block lg:w-1/2" style={{ backgroundImage: "url('/assets/sign-in.png')" }}></div>

      <div className="w-full px-6 py-4 md:px-8 lg:w-1/2">
        <div className="flex justify-center mx-auto">
          <Image className="w-auto h-7 sm:h-20" src="/assets/BrainWave-logo.png" alt="Logo" width={100} height={100}/>
        </div>
        ...
        <div className="mt-6">
          <Button className="w-full px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-700 rounded-lg hover:bg-blue-300 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-50">
            Sign In
          </Button>
        </div>
        <div className="flex gap-2 mx-4 my-2 items-center">
          <h1 className="">Don{'`'}t Have a account ?</h1>
          <span><Link href="/sign-up" className="text-sm text-gray-500 uppercase dark:text-gray-400 hover:underline">Sign Up</Link></span>
        </div>
